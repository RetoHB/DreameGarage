...
## Introduction
A WiFi-connected garage door controller that automatically opens and closes a garage door based on the state of a Dreame robot vacuum, using Home Assistant, Adafruit IO as a cloud bridge and an ESP32-class microcontroller for real-time motor control.
## General Description
